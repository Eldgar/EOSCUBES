...
public:
    ...
    struct [[eosio::table]] cube_price
    {
        ...
        auto primary_key() const { return id; }
        auto second_key() const { return x; }
        auto third_key() const { return y; }
        auto fourth_key() const { return z; }
        //EOSLIB_SERIALIZE( cube, (id)(username)(key)(pos)(texture))
    };
    typedef eosio::multi_index<"cube_prices"_n, cube_price>     cube_prices;
